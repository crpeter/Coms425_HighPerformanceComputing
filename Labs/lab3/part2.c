...
void median( int answer[] )
{
 ...
 if (SIZE % 2 == 0) {
	 printf("\n\nThe median is element %d & %d of\n"
		 "the sorted %d element array.\n"
		 "For this run the median is %f\n\n",
		 SIZE / 2, SIZE / 2 - 1, SIZE, (double)(answer[SIZE / 2] + answer[SIZE / 2 -1])/2);
 }
 else {
